...
const HeroBanner = () => (
  <Box sx={{ mt: { lg: '212px', xs: '70px' }, ml: { sm: '50px' } }} position="relative" p="20px">
    ...
    <Typography fontWeight={700} sx={{ fontSize: { lg: '50px', xs: '40px' } }} mb="23px" mt="30px" style={{color: 'goldenrod'}}>
      " Train, Eat, Sleep, <br />
      And Repeat "
    </Typography>
    ...
    <Typography fontWeight={600} color="goldenrod" sx={{ opacity: '0.1', display: { lg: 'block', xs: 'none' }, fontSize: '180px', color: 'goldenrod', fontFamily:'Poppins', marginTop:'120px', textAlign:'left' }}>
      Exercise
    </Typography>
